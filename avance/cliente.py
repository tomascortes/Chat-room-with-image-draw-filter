...
class Cliente:
    ...
    def manejar_comando(self, diccionario):
        ...
        if diccionario["status"] == "eliminacion":
            print('alguien fue eliminado')
            print(diccionario["data"])
            print( self.frontend.nombre_usuario)
            print('-'*50)
            if diccionario["data"] == self.frontend.nombre_usuario:
                self.terminar_conexion()
            # else:
            #     data = diccionario["data"]
            #     usuario = 'servidor'
    ...
    def terminar_conexion(self):
        ...
        self.frontend.ventana_chat.hide()
        exit()
